"""RADAR-Vicuna-7B detector adapter implementation."""
...
class RadarVicuna7BDetector(AbstractDetector):
    """Detector adapter for `TrustSafeAI/RADAR-Vicuna-7B`."""
    ...
    @classmethod
    def initialize(cls, config: DetectorConfig) -> "RadarVicuna7BDetector":
        torch_module = importlib.import_module("torch")
        transformers_module = importlib.import_module("transformers")

        model_id = _read_string(config, "model_id", default="TrustSafeAI/RADAR-Vicuna-7B")
