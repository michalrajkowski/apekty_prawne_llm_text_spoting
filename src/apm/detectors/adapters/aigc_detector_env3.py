"""AIGC Detector V3 adapter implementation."""
...
class AIGCDetectorEnv3(AbstractDetector):
    """Detector adapter for `yuchuantian/AIGC_detector_env3`."""
    ...
    @classmethod
    def initialize(cls, config: DetectorConfig) -> "AIGCDetectorEnv3":
        torch_module = importlib.import_module("torch")
        transformers_module = importlib.import_module("transformers")

        model_id = _read_string(config, "model_id", default="yuchuantian/AIGC_detector_env3")
